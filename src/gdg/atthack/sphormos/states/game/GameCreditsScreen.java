...
public class GameCreditsScreen extends GameState<Game> 
{
	...
	public void onDraw(Game owner, Canvas canvas) 
	{
		BitmapContainer.getInstance().drawSafely(canvas, 
				BitmapContainer.getInstance().getCreditsImage(), 
	...
	public void onEnter(Game owner) 
	{
		m_rectSrc = new Rect(0, 0, 
				BitmapContainer.getInstance().getCreditsImage().getWidth(), 
				BitmapContainer.getInstance().getCreditsImage().getHeight());
